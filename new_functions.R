...
worldbasemap = function()
{
  ...
  lbl.X = read.csv("lbl.X.csv", fileEncoding = "ISO-8859-1")
  lbl.Y = read.csv("lbl.Y.csv", fileEncoding = "ISO-8859-1")
...
migrationmap_bare = function(n=1, Species1,SciName, rawpath1, rawpath2=NA, rawpathPhoto,  res = 120, range = 30,
                        step = 10, fps = 2, col1 = "red", col2 = "blue", pointsize, yaxis,
                        world = F, minlong = -15, 
                        minlat = -33, maxlong = 180, maxlat = 70,ggp,dataall,migstatus,credit,impos,grpos,
                        credit_color = "black")
