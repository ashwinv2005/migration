...
migrationmap2 = function(Species1, Species2, rawpath1, rawpath2, rawpathPhoto1, rawpathPhoto2,  res = 120, 
                         ...
                         migstatus1,migstatus2,credit1,credit2,impos,grpos)
{
  require(tidyverse)
  require(rgdal)
  require(magick)
  ...
  a1 = image_annotate(a1, credit1, font = 'Gill Sans', size = 24, location = "+8+4")
  
  a2 = image_read(rawpathPhoto2)
  a2 = image_scale(a2, "300")
  a2 = image_border(a2, "#ffffff", "3x3")
  a2 = image_annotate(a2, credit2, font = 'Gill Sans', size = 24, location = "+8+4")
  ...
  for (i in l){
    ...
    if(impos == "BL")
    {
      vq = viewport(width = wd1, height = 0.04, x = 0.107,
                    y = 0.99, just = c("center","top"))
    }
    else{
    ...
    if(impos == "BL")
    {
      vr = viewport(width = wd2, height = 0.04, x = 0.107,
